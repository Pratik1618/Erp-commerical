...
const api =global(); // Call the function and assign the returned value
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  document
    ...
    .addEventListener("submit", function (event) {
      ...
      const materailName = document.getElementById("materailName").value;
...
//data table of client
  ...
  const table = $("#machinerytable").DataTable({
      ajax: {
          url: `${api}/material`, // Replace with your API endpoint
          dataSrc: '',
          headers: {
            'Authorization': `${token}`},
      },
  ...
  window.deleteClient = function (id) {
      if (confirm("Are you sure you want to delete this Materail?")) {
