...
document.addEventListener("DOMContentLoaded", function () {
  ...
  document
    ...
    .addEventListener("submit", function (event) {
      ...
      const machineryName = document.getElementById("machineryName").value;
...
//data table of client
  ...
  const table = $("#machinerytable").DataTable({
      ajax: {
          url: `${api}/machinery`, // Replace with your API endpoint
          dataSrc: '',
          headers: {
            'Authorization': `${token}`},
      },
